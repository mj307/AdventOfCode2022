...
#print (sumList)
print (sorted(sumList)) # this gives the size of the biggest directory
totalSize = sorted(sumList, reverse = True)[0]
print (70000000-totalSize)
totalSpaceTaken = 70000000-totalSize
unusedSpaceNeeded = 30000000
remainingSpace = unusedSpaceNeeded-totalSpaceTaken
print (remainingSpace) #space that needs to be removed to there's enough disk space

min_diff = totalSize - remainingSpace
for a in sumList:
    if (a-remainingSpace) < min_diff and (a-remainingSpace) > 0:
        min_diff = a
